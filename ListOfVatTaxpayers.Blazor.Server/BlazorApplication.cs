...
namespace ListOfVatTaxpayers.Blazor.Server {
    public partial class ListOfVatTaxpayersBlazorApplication : BlazorApplication {
        public ListOfVatTaxpayersBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void ListOfVatTaxpayersBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else

...
namespace ListOfVatTaxpayers.Module.BusinessObjects
{
    ...
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        ...
        {
            get { return GetCollection<Entity>(nameof(Entities)); }
        }

        private ListViewEntry listViewEntry;
        [Association("EntryListView-Entries")]
        public ListViewEntry ListViewEntry
        {
            get { return listViewEntry; }
            set { SetPropertyValue(nameof(ListViewEntry), ref listViewEntry, value); }
        }
    }
}